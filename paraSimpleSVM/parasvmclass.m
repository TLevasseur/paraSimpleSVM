function [xsup,w,d,pos,timeps,alpha,obj]=parasvmclass(x,y,c,lambda,kernel,kerneloption,verbose,span, alphainit)
% USAGE [xsup,w,b,pos,timeps,alpha,obj]=paraclass(x,y,c,lambda,kernel,kerneloption,verbose,span, alphainit)
%
...
% 
%   DOES THE SAME THING AS svmclass FUNCTION; ONLY CALLS paramonqp
%
%
% INPUT
%
...
if isinf(c)                                                           
    ...
    [alpha , lambda , pos] = paramonqp(H,e,A,b,c,lambda,verbose,x,ps,alphainit);         
